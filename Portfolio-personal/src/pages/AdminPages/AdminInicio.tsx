import { useStore } from "@/components/Context/Contexto"; // Tu ruta exacta de Contexto
import { BookOpen, Wrench, Briefcase, ShoppingBag, ArrowRight, Mail } from "lucide-react";
...
export const AdminInicio = () => {
  ...
  // Traemos tus colecciones reales con fallback array para evitar errores de .length
  const { cursos = [], servicios = [], trabajos = [], productos = [], sociales = [], loading } = useStore();
  ...
  const stats = [
    ...
    { label: "Productos", count: productos.length, icon: ShoppingBag, to: "/admin/productos", color: "#ec4899" },
    { label: "Contactos", count: sociales.length,  icon: Mail,        to: "/admin/sociales",  color: "#ec4848" },
  ];
